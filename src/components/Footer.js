        ...
        return (
            <div className="footer-container">
                ...
                <ul className="footer-list">
                    <li><h4 class="footer-list-header">About Us</h4></li>
                    <li><a href='/shop/about-mission' className="hihi" itemprop="significantLink">GET TO KNOW US</a></li>
                ...
                <ul class="footer-list-top">
                    <li>
                    <h4 class="footer-list-header">Hi</h4></li>
